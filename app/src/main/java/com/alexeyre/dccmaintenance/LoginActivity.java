...
public class LoginActivity extends AppCompatActivity {
    ...
    private void attemptLogin(String username, String password) {
        ((TextInputEditText) findViewById(R.id.login_username)).setError(null);
        ((TextInputEditText) findViewById(R.id.login_password)).setError(null);
        if (username.equals("")) {
            ((TextInputEditText) findViewById(R.id.login_username)).setError("Username Required");
            return;
        }
        if (password.equals("")) {
            ((TextInputEditText) findViewById(R.id.login_password)).setError("Password Required");
            return;
        }
    }
